...
export type BlogPostsQuery = { allMarkdownRemark: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date'>>, fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>> } }> } };
...
export type Unnamed_4_Query = { allMarkdownRemark: { edges: Array<{ node: { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>> } }> } };
